  ...
  <div class="container px-5 py-24 mx-auto">
    ...
    <div class="flex flex-wrap -m-4">
      <div class="lg:w-1/4 md:w-1/2 p-4 w-full">
        <a class="block relative h-48 rounded overflow-hidden cursor-pointer" href='https://academia-seven-omega.vercel.app/'>
      ...
      <div class="lg:w-1/4 md:w-1/2 p-4 w-full">
        <a class="block relative h-48 rounded overflow-hidden cursor-pointer" href='https://acme-drab-three.vercel.app/'>
      ...
      <div class="lg:w-1/4 md:w-1/2 p-4 w-full">
        <a class="block relative h-48 rounded overflow-hidden cursor-pointer" href='https://code-upscale.vercel.app/'>
      ...
      <div class="lg:w-1/4 md:w-1/2 p-4 w-full">
        <a class="block relative h-48 rounded overflow-hidden cursor-pointer" href='https://e-store-gules-six.vercel.app/'>
      ...
      <div class="lg:w-1/4 md:w-1/2 p-4 w-full">
        <a class="block relative h-48 rounded overflow-hidden cursor-pointer" href='https://genial-one.vercel.app/'>
      ...
      <div class="lg:w-1/4 md:w-1/2 p-4 w-full">
        <a class="block relative h-48 rounded overflow-hidden cursor-pointer" href='https://neve-zeta.vercel.app/'>
